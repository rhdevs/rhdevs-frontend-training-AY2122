...
const Hubble = React.lazy(() => import(/* webpackChunckName: "HUBBLE" */ '../pages/FrontendMentor/hubble'))
...
export const Routes = () => (
  <Switch>
    ...
    <RouteWithTopNav exact path={PATHS.FRONTEND_MENTOR_HUBBLE} component={Hubble} />
